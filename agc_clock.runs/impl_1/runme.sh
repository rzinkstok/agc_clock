...
HD_PWD='C:/Users/rzine07792/source/rzinkstok/agc_clock/agc_clock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log agc_clock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source agc_clock.tcl -notrace
